    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <a href="{{ route('koperasi.kategori.create') }}" class="action-modal m3-btn-primary text-xs">
        ...
        <div id="data-grid-container"
            class="m3-glass-card rounded-2xl md:rounded-3xl overflow-hidden flex flex-col relative z-10 shadow-sm dark:shadow-none">
