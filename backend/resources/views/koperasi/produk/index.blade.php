    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 relative z-10">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('koperasi.pembelian.index') }}"
                class="inline-flex items-center justify-center gap-1.5 bg-teal-500/10 hover:bg-teal-500/20 text-teal-700 dark:text-teal-400 border border-teal-500/20 font-bold rounded-xl md:rounded-2xl min-h-[40px] px-4 py-2 text-xs shadow-2xs active:scale-95 transition-all">
                <i class="bi bi-bag-plus-fill text-sm"></i>
                <span>Kulakan Stok</span>
            </a>

            <a href="{{ route('koperasi.produk.barcode-massal') }}"
