<div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md transition-opacity duration-300 animate-in fade-in"
    ...
    <div
        class="m3-glass-card !bg-white/95 dark:!bg-zinc-900/95 backdrop-blur-2xl border border-zinc-200/80 dark:border-zinc-800/80 rounded-3xl w-full max-w-md flex flex-col shadow-2xl overflow-hidden transform transition-all animate-in zoom-in-95 duration-200">
        ...
        <div
            ...
            <div class="flex items-center gap-3">
                <div
                    class="w-10 h-10 rounded-2xl bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center font-black text-lg border border-amber-500/20 shadow-2xs">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 font-medium" id="resetUserTargetName">
                        Setel password baru untuk akun pengguna
                    </p>
                </div>
            </div>
        ...
        <form id="resetPasswordForm" method="POST" class="p-6 space-y-4">
            ...
            <div id="resetErrorAlert"
                class="hidden p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 text-xs font-bold">
            </div>

            <div
                class="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-300 text-xs font-medium leading-relaxed flex items-start gap-2">
                <i class="bi bi-exclamation-circle-fill text-amber-600 mt-0.5 flex-shrink-0"></i>
                <span>Setelah password direset, seluruh sesi aktif user ini akan diputus dan wajib login ulang
                    menggunakan password baru.</span>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="password" id="resetNewPassword" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="password_confirmation" id="resetNewPasswordConfirm" required
            ...
            <div class="pt-4 border-t border-zinc-200/80 dark:border-zinc-800 flex items-center justify-end gap-2.5">
                ...
                <button type="submit" id="btnSubmitReset"
                    class="h-10 px-6 rounded-xl md:rounded-2xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-black shadow-md flex items-center gap-1.5 transition-all active:scale-95">
                    <i class="bi bi-key-fill"></i>
