<form action="{{ route('ustadz.import.store') }}" method="POST" enctype="multipart/form-data"
    ...
    <div
        ...
        <div>
            ...
            <p class="text-[10px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mt-0.5">
                Unggah berkas CSV data dewan asatidz
            </p>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <ol
                    ...
                    <li>Isi data sesuai format dengan benar. Format Tanggal Lahir: <strong
