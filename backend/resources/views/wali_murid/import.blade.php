<form action="{{ route('wali-murid.import.store') }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="p-5 md:p-6 transition-colors overflow-y-auto custom-scrollbar flex-1 space-y-4">
        ...
        <div
            ...
            <div>
                ...
                <ol
                    ...
                    <li>Isi data sesuai kolom dengan benar. Format Tanggal: <strong
                            class="font-mono text-blue-800 dark:text-blue-200">YYYY-MM-DD</strong>.
                    </li>
        ...
        <a href="{{ route('wali-murid.template') }}"
